...
const Navbar = () => {
  return (
    <div className="flex bg-purple-800 justify-between items-center px-6 py-8 border-b-2 border-purple-200 mb-12">
      <span className="text-white">Back</span>
      <h2 className="text-xl text-white">Pick a Game</h2>
